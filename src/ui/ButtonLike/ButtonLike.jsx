...
export const ButtonLike = ({ handleButtonClick }) => {
    return (
        <button className='btn' onClick={handleButtonClick}>
            <svg xmlns="http://www.w3.org/2000/svg" width="118" height="118" viewBox="0 0 118 118" fill="none">
                <g filter="url(#filter0_d_2536_1008)">
                    <circle cx="59" cy="51" r="24" fill="white" />
                </g>
                <path fillRule="evenodd" clipRule="evenodd" d="M58.9997 41.9711C65.6567 35.1281 82.3007 47.1026 58.9997 62.5001C35.6987 47.1041 52.3427 35.1281 58.9997 41.9711Z" fill="#DC3545" />
                <defs>
